 ...
 * @return {boolean} If build is deleted successfully then return true otherwise false.
 */
AutomationApiClient.prototype.updateBuildById = function(
  buildId,
  requestBody,
  fnCallback
) {
 ...
 */
AutomationApiClient.prototype.fetchSessionById = function(
  sessionId,
  fnCallback
) {
 ...
 */
AutomationApiClient.prototype.deleteSessionById = function(
  sessionId,
  fnCallback
) {
  if (typeof sessionId === "function" || typeof sessionId === "object") {
 ...
 * @return {boolean} If session is deleted successfully then return true otherwise false.
 */
AutomationApiClient.prototype.updateSessionById = function(
  sessionId,
  requestBody,
  fnCallback
) {
 ...
 */
AutomationApiClient.prototype.fetchSessionScreenshot = function(
  sessionId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
 ...
 */
AutomationApiClient.prototype.fetchSessionVideo = function(
  sessionId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
 ...
 */
AutomationApiClient.prototype.fetchSessionCommandLogs = function(
  sessionId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
 ...
 */
AutomationApiClient.prototype.fetchSessionSeleniumLogs = function(
  sessionId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
 ...
 */
AutomationApiClient.prototype.fetchSessionNetworkLogs = function(
  sessionId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
 ...
 */
AutomationApiClient.prototype.fetchSessionConsoleLogs = function(
  sessionId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
 ...
 */
AutomationApiClient.prototype.deleteTunnelById = function(
  tunnelId,
  fnCallback
) {
  fnCallback = fnCallback || function() {};
